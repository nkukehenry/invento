            ...
            <div class="panel-body">
                ...
                <?= form_open_multipart('customer/customer/form') ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                                    <input name="customer_code" class="form-control" type="text" placeholder="<?php echo display('customer_code') ?>" id="customer_code" value="<?php echo $customers->customer_code; ?>" required>
